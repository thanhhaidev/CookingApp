...
public class SearchFragment extends Fragment {
    ...
    private void loadListFoodSearch(String value) {
        try {
            ...
            Request request = new Request.Builder()
                    ...
                    .build();
            showProgressDialog("Search food success");
    ...
    class FoodListAdapter extends RecyclerView.Adapter<SearchFragment.FoodViewHolder> {
        ...
        @Override
        public SearchFragment.FoodViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_item, parent, false);
            return new SearchFragment.FoodViewHolder(view);
        }
