package xyz.thanhhaidev.cooking.websockets;
...
public class WebsocketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xyz.thanhhaidev.cooking.R.layout.activity_websocket);

        message = findViewById(xyz.thanhhaidev.cooking.R.id.message);
        sendButton = findViewById(xyz.thanhhaidev.cooking.R.id.sendButton);
