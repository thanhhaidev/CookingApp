package xyz.thanhhaidev.cooking.filestore;
...
public class FilestoreActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xyz.thanhhaidev.cooking.R.layout.activity_filestore);

        findViewById(xyz.thanhhaidev.cooking.R.id.uploadButton_image).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                BottomSheetImagePicker
                        ...
                        .showImagePicker(
                                ...
                                (BottomSheetLayout) findViewById(xyz.thanhhaidev.cooking.R.id.bottomsheet),
        ...
        findViewById(xyz.thanhhaidev.cooking.R.id.uploadButton_random).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
